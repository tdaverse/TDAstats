...
TDAstats transitioned to legacy status:
No new features or refactoring are planned.
Ongoing maintenance will focus only on compatibility with dependency upgrades.
See the README for suggested alternatives.
